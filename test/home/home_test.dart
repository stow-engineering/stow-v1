...
void main() {
  ...
  testWidgets('Home page test', (tester) async {
    ...
    //create finders
    final greetingFinder = find.textContaining('Hi there');
    final buttonTextFinder = find.textContaining('Pantry');
    final containersFinder = find.textContaining('Containers');

    //expect
    expect(greetingFinder, findsOneWidget);
    expect(buttonTextFinder, findsOneWidget);
    expect(containersFinder, findsOneWidget);
  });
}
