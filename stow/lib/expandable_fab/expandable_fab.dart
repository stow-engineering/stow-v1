...
//           BlocBuilder<ExpandableFabBloc, ExpandableFabState>(
//             bloc: BlocProvider.of<ExpandableFabBloc>(context),
//             builder: (context, state) {
//               return _buildTapToOpenFab(context, state.open);
//             },
//           ),
//         ],
//       ),
...
//           elevation: 4.0,
//           child: InkWell(
//             onTap: (() => {context.read<ExpandableFabBloc>().add(Toggle())}),
//             child: Padding(
...
//   Widget _buildTapToOpenFab(BuildContext context, bool open) {
...
//             onPressed: (() =>
//                 {context.read<ExpandableFabBloc>().add(Toggle())}),
